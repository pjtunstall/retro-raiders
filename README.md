...
- To let players enjoy the advantage of better hardware for smoother animation, use interpolation to fill in intermediate stages when translating a sprite. You can either do this by hand using JavaScript. In `gameLoop`, calculate the actual time elapsed between frames as a proportion of 1/60th of a second:
