...
const chapter = [
  ...
  "The Ingredients of our Poisoned Mutex",
  "Beware the IDEs of March",
  "Azure Like It",
  "Infinite Jest",
  "This Too Too SOLID State",
  "Life's but a Walking Shadow DOM",
  "A Poor Player that Structs<br>and Frets his Hour upon the Stage",
  "Gain of Function",
  ...
  "The Catcher in the RAII",
  "2, 4, 6, 8, Who Do We async/await?",
  ...
  "Web Workers of the World, Unite!<br>(You have Nothing to Lose but your Prototype Chains.)",
  "The Urge to Destructure is also a Creative Urge",
  "A Stitch in Unix Time",
  "Too Many Qux Spoil the Baz",
  "Perl Before Swine",
  "The Erlang Goodbye",
  "Blaisingly Pascal",
  "Go &agrave; Gogo",
  ...
  "BASIC Instinct",
  "UTF-8al Attraction",
  "The Return of the Cloud-Native",
  "That Mysterious Object of Desire",
  "The Holy Modal Windows",
  "Curly Brace yourself for It",
  "Gladly the Cross-Origin Bear",
  "Bada Bing",
  "Bard for Life",
  "The End is Gemi-Nigh",
  "Frankly, my dear, I Don't Give a DOM",
  "Ooh Err",
  "'ip 'ip 'Array",
  "And Did those Vite in Ancient Times",
  "Flip the Script",
  "Derby RAM",
  "The Elephant in the ROM",
  "Code Comfort Farm",
  "Bi-Nary, Pay Later",
  "What the Hex?",
  ...
  "Freude, sch&ouml;ner G&ouml;tterfunction",
  "Navigator, Navigator, Rise Up and Be Strong",
  "This Floating Point",
  "Little BigInt",
  "My Old Man's a Garbage Collector",
  "Not One JWT",
  "You Say Paseto, I Say Potato",
  "JIT Kune Do",
  ...
  "2001: A Space Bar Odyssey",
  "Blade Test Runner",
  "The Thing from Another Hello World",
  "Invasion of the response.body Snatchers",
  "The Big Omega Man",
  "The Mummy's Recurse",
  "Resident eval()",
  "Buffer the Vampire Slayer",
  "The setTimeout Machine",
  "require('invisible');",
  "The Moduellists",
  "Polyfill the Kettle Up",
  "Time's Arrow Function",
  "Voxel Bridge",
  ...
  "Look what the Net Cat Dragged In",
  "Sometimes when you're O(n)",
  "The Devil Can Quote JavaScripture",
  "The Go-Between",
  "Royal OOPSLA",
  "The Process and the Pea",
  "The Dead Sea scrollHeight",
  "Det &auml;r ingen konst,<br>det &auml;r mycket l&auml;tt",
  "First-Class Citizen Kane",
  "No Country for Old main()",
  "Gravity's Rainbow Table",
  "One Flew Over the Cuckoo's Nested Function",
  "The Garden of Forking Processes",
  "Server Side Story",
  "Finnegan's WakeLock",
  "Ponder's Endpoint",
  "The Wages of Syntax",
  ...
  "The Big time.Sleep(1 * time.Second)",
  ...
  "Turing a Ring o' Roses",
  "I'm Forever Blowing Bubble Sort",
  "Lucy in the Sky with Radix Sort",
  "Risk it for the Quiskit",
  "Hoist by your Own Hadamard",
  "In a Hole in the Ground, there lived a Qubit",
  "In this Increment Weather",
  "Web Manifest Destiny",
  "Best Beforeend",
  "How to Tame your Dragend",
  "Slice of Life",
  "Splice the main() Brace",
  "The Dreadful Language of the Varargs",
  "Chicken Proxy",
  "All Along the Watchpoint",
  "Fahrenheit 418 I'm a Teapot",
  "Who Handles the Event Handlers?",
  "The Devil Makes Work for Idle Frames",
  "SaaS-quatch Out, it's BigInt!",
  "The Currying Game",
  "The Ties that.bind()",
  ".apply(yourself)",
  "Show Me<br>the Interface you Had<br>before you Were Born",
  "Run, Run, Run",
  "I'm a Backend Man",
  "DOM and (Re)Base",
  "Have a ('b' + 'a' + + 'a' + 'a').toLowerCase()",
  "Mother, Where's your No Mangle",
  "!!!in' on Heaven's Door",
  ...
  "Mutex-Mex",
  "Temp File Fugit",
  "We'll Roll the Old `char`-iot Along",
  ...
  "The Straw that Broke the Camel Case",
  "The Borrowers",
  "u8 for It",
  "All the fn of the Fair",
  ...
  "I May as Well Try to catch_unwind",
  "Glob of the Gaps",
  "The Lord of the RNGs",
  "Smells Like Subroutine Spirit",
];
