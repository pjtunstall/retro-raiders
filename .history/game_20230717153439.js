...
export const sendScore = async ({playerName, score, second, minute}) => {
  try {
...
export const deleteMinimumScore = () => {
...
export const updateScoresOnAdd = ({playerName, score, second, minute}) => {
