...
const storyTestArr = [
  [
    ...
    `From the memoirs of Exentius Persei, Ambassador of the Hmadian Macrostates, on concluding his negotiations with FnrRa Gfgfgg (2^<sup>2</sup> - 1)st Grand Eskalir of Grumium.
