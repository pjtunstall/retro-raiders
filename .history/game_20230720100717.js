...
function launchUfo() {
  ...
  voltage.play();
  ufoActive = true;
 ufoScorePointerscorePointer++;
  if (this.scorePointer > 15) {
    this.scorePointer = 0;
  }
  this.element = document.createElement("div");
  this.element.id = "ufo-container";
  this.element.classList.add("ufo-container");
  const html = `
  ...
  this.gamePlay.appendChild(this.element);
  this.beamElement = document.querySelector(".beam");
