...
const storyTestArr = [
  [
    ...
    `From the memoirs of Exentius Persei, Ambassador of the Hmadian Macrostates, on concluding his negotiations with FnrRa Gfgfgg (2^ - 1)st Grand Eskalir of Grumium.
